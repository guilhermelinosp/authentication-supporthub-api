...
namespace SupportHub.Auth.Domain.DTOs.Responses.APIs;

public class ResponseCnpj
{
    public string Cnpj { get; set; } = string.Empty;
    [JsonProperty("descricao_matriz_filial")] public string DescricaoMatriz { get; set; } = string.Empty;
    ...
    [JsonProperty("cnae_fiscal_descricao")]public string CnaeDescricao { get; set; } = string.Empty;
    [JsonProperty("descricao_tipo_logradouro")] public string DescricaoLogradouro { get; set; } = string.Empty;
