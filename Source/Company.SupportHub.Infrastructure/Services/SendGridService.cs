...
public class SendGridService(IConfiguration configuration) : ISendGridService, IInfrastructureInjection
{
	public async Task SendSignUpAsync(string email, string code)
	{
		...
		var from = new EmailAddress(configuration["SendGrid_FromEmail"]!, configuration["SendGrid_FromName"]!);
        ...
        <p>If you did not create an account with Support Hub or have any concerns, please contact our support team at {configuration["SendGrid_FromEmail"]}.</p>
